    ...
    _createClass(Select, [{
        ...
        value: function getVisibleItems() {
            ...
            Object.keys(this.props.items).forEach(function (key) {
                ...
                if (!_this3.state.filter || _this3.props.items[key].toLowerCase().indexOf(_this3.state.filter.toLowerCase()) !== -1) {
                    visibleItems.push(_react2.default.createElement(
                        'div',
                        {
                            onClick: function onClick() {
                                ...
                                _this3.setState({
                                    selectedItem: key,
                                    selectedItemLabel: _this3.props.items[key],
                                    open: false
                                }, function () {
                            ...
                            key: key,
                            className: key == _this3.state.selectedItem ? "item item-selected" : "item"
                        },
                        _this3.props.items[key]
                    ));
                }
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    {
                        onClick: function onClick() {
                            _this5.toggle(!_this5.state.open);
                        },
